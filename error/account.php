            ...
            <div class="card border-0 shadow m-5 bg-body rounded">
                <div class="d-flex justify-content-center flex-column">
                    <div class="bg-primary text-white p-3 mt-3 mb-3" style="background-color:#fd7e14!important;">
                        <div class="text-center display-1"><i class="fas fa-surprise"></i></div>
                        <div class="text-center display-1">Usuario activo en otra PC o Navegador</div>
                    </div>
                    <div class="text-center fs-5">Advertencia! un usuario ingreso recientemente con su cuenta</div>
                    <div class="text-center fs-5">Vuelva a ingresar sus datos nuevamente por favor</div>
